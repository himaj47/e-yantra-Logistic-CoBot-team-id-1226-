...
class NavigationDockingController(Node):
    def __init__(self):
        ...
        self.waypoints = [
            self.create_goal_pose(0.49, -2.30, 1.87),  # Drop pose
            self.create_goal_pose(2.72, 2.90, -1.90),  # Conveyor 2
            self.create_goal_pose(2.72, 2.90, -1.90),  # Conveyor 2
            self.create_goal_pose(0.51, -2.62, -1.85),  # Drop pose
            self.create_goal_pose(-4.50, 2.89, -1.27),  #Conveyor 1
            self.create_goal_pose(-4.50, 2.89, -1.27)   # Conveyor 1
        ]
    ...
    def execute_navigation(self):
        ...
        self.navigator.followWaypoints(self.waypoints[:3])
