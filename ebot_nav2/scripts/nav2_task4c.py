...
class NavigationDockingController(Node):
    def __init__(self):
        ...
        self.conveyor2_waypoint = [
            self.create_goal_pose( 2.42,  2.55, -1.57),  # Conveyor 2  2.42,  2.55, -1.57
    ...
    def box_payload (self,pickup):
        ...
        This function initiates a payload action by calling a service to perform a specified action (e.g., dropping an item), 
         It sends an asynchronous service request and waits for the result. The function logs 
        the service request and its outcome.
    ...
    def conveyor2_pose(self,box_name):
        ...
        while not self.navigator.isTaskComplete():
            ...
            if feedback:
                ...
                if current_waypoint in [2,4,6] and not self.actions_triggered[current_waypoint-1]:
                    ...
                    docking_success = self.initiate_docking(target_distance=0.09, orientation_angle=1.63, rack_number='')              
    ...
    def conveyor1_pose(self,box_name):
