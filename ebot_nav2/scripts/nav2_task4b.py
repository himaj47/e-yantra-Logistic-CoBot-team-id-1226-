...
class NavigationDockingController(Node):
    def __init__(self):
        ...
        global pre_goal
        self.arm_pose = [
            self.create_goal_pose(3.48, -2.55, -1.57),  # recieve pose  0.95, -2.54, 1.87
            self.create_goal_pose(3.48, -2.55, -1.57),  # recieve pose  0.95, -2.54, 1.87
        ...
        self.conveyor2_waypoint = [
            self.create_goal_pose(3.21, 1.28, -1.57),  # Conveyor 2  2.42,  2.55, -1.57
            self.create_goal_pose(3.21, 1.28, -1.57),  # Conveyor 2
        ]

        self.conveyor1_waypoint=[
            self.create_goal_pose(3.33, 1.83, -1.57),  # Conveyor 1  -4.4,  2.89, -1.57
            self.create_goal_pose(3.33, 1.83, -1.57),  # Conveyor 1
        ]
    ...
    def execute_navigation(self):
        ...
        self.arm_pose(pose=receive_pos)
